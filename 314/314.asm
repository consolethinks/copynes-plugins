;Mapper 314 dumper (WLA-DX assembler)
...
chr_loop:
             ...
             clc
             rol a
             sta $5000      ;write part 1 of bank
             lda curr_bank
             and #$3c
             lsr a
             lsr a
             sta $5002      ;write part 2 of bank
             lda curr_bank
