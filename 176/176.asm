;Mapper 176 dumper (WLA-DX assembler)
...
;send PRG data
             ...
             jsr send_byte
;init mapper
             lda #$04       ;NROM-256, CNROM CHR 32KB outer bank
             sta $5FF0
             lda #$00
             sta $5FF1      ;NROM-256, PRG bank 0
...
prg_loop:
             ...
             sta $5FF1
             lda curr_bank
             cmp #$20       ;1MB, if not over max bank -> loop
             bne prg_loop
;send CHR data
...
chr_loop:
             ...
             sta $8000
             lda curr_bank
             cmp #$80       ;1MB, if not over max bank -> loop
             bne chr_loop
;finalize
