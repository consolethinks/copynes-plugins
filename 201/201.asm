;Mapper 212 dumper (WLA-DX assembler)
;06/11/2021 - by Consolethinks
...
;send PRG data
             ...
             jsr send_byte
             lda #$01       ;prg size high byte (low is always $00)
             jsr send_byte
             lda #$01       ;send prg
             jsr send_byte
;init mapper
             lda #$00       ;NROM-256, Bank 0
             sta $8000
...
prg_loop:
             ...
             sta $8000,x
             lda curr_bank
             cmp #$02       ;64KiB, if not over max bank -> loop
             bne prg_loop
;finalize
